...
export const CITY_TEMPLATES = {
  ...
  balanced: {
    name: 'Balanced City',
    description: 'Equal RCI zones, fire station, and petroleum power — ready for disasters.',
    budget: 4500,
    buildings: [
      { x: 8, y: 8, type: 'power-plant-petroleum' },
      { x: 7, y: 8, type: 'power-line' },
      { x: 9, y: 8, type: 'power-line' },
      { x: 7, y: 7, type: 'road' },
      { x: 8, y: 7, type: 'road' },
      ...
      { x: 8, y: 6, type: 'fire-station' },
    ],
  },
  'disaster-lab': {
    name: 'Disaster Lab',
    description: 'Dense zones, waterfront, nuclear plant — practice floods, fires, and meltdowns.',
    budget: 6000,
    buildings: [
      { x: 8, y: 8, type: 'power-plant-petroleum' },
      { x: 12, y: 8, type: 'power-plant-nuclear' },
      { x: 7, y: 8, type: 'power-line' },
      { x: 9, y: 8, type: 'power-line' },
      { x: 11, y: 8, type: 'power-line' },
      { x: 13, y: 8, type: 'power-line' },
      { x: 7, y: 7, type: 'road' },
      { x: 8, y: 7, type: 'road' },
      { x: 9, y: 7, type: 'road' },
      { x: 10, y: 7, type: 'road' },
      ...
      { x: 5, y: 6, type: 'residential' },
      { x: 5, y: 7, type: 'residential' },
      { x: 6, y: 5, type: 'commercial' },
      { x: 6, y: 6, type: 'commercial' },
      { x: 10, y: 5, type: 'industrial' },
      { x: 10, y: 6, type: 'industrial' },
      { x: 11, y: 5, type: 'industrial' },
      { x: 8, y: 6, type: 'fire-station' },
      { x: 4, y: 8, type: 'fire-station' },
    ],
  },
};
